...
import { ProductCatalogComponent } from '../product-home/product-catalog/product-catalog.component';
import { ProductDetailComponent } from '../product-home/product-detail/product-detail.component';
import { BookComponent } from '../book/book.component';
import { ExamDemoComponent } from '../exam-demo/exam-demo.component';
import { SlickCarouselModule } from 'ngx-slick-carousel';
import { FullExamComponent } from '../full-exam/full-exam.component';
import { PagenewsComponent } from '../news_session/pagenews/pagenews.component';
const routes: Routes = [
  {
    path: 'hometotal',
    ...
    children: [
      ...
      {
        path: 'examdemo',
        component: ExamDemoComponent
      },
      {
        path:'pagenews/news/viewnews/:id',
        component:PagenewsComponent
      },
      {
        path:'fullexam',
        component:FullExamComponent
      },
      {
        path: 'examdemo/:param1',
        component: ExamDemoComponent
      },
      {
        path: '',
