...
export class LoginComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/hometotal/examhistory';
      ...
      this.authenticationService
        ...
        .subscribe(
          res => {
            ...
            localStorage.setItem('timeout', res['timeout']);
    ...
    if (!this.jwtHelper.isTokenExpired(token) && email != null) {
      ...
      .subscribe(
        res => {
          ...
          if (localStorage.getItem('backURL') == null || localStorage.getItem('backURL') === '/hometotal/login') {
