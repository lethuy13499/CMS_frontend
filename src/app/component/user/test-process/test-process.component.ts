...
export class TestProcessComponent
  ...
  ngOnInit() {
    ...
    this.examService
      .getExamReSultByExamAndId(this.examUserID, this.idExam)
      .pipe(
        tap(res => {

          if (
            (res['user']!=null && res['user']['email'] !==
            JSON.parse(localStorage.getItem('item')).email)&&(res['exam']['examMode']!==1)
          ) {
            this.isOver = true;
          ...
          if (res['completed'] === 2) {
            ...
            this.router.navigate([
              ...
              { param1: this.idExam, param2: this.examUserID }
            ]);
          }
        }),
