...
export class TestresultComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //             this.mapAnswer.set(element2['question_id'], element2['choose_answer']);
    //             this.mapCheckQuestion.set(
    //               element2['question_id'],
    //               this.checkCorrect(
    //                 element2['choose_answer'],
    //                 this.mapQuesTion.get(element2['question_id'])
    //               )
    //             );
    //           });
    ...
    //               correct: false
    //             };
    //             re.quesId = this.mapQuesTionMoi[index]['question_id'];
    //             re.ques = this.mapQuesTionMoi[index]['choose_answer'];
    //             re.correct = this.mapCheckQuestionMoi[index]['choose_answer'];
  ...
  showResulerFreeUser() {
    ...
    if (sessionStorage.getItem(this.examId.toString()) != null) {
      ...
      this.question_not_answered = output['exam']['question_num'] - this.lenAnswered;
      if(this.corect == 0 && this.lenAnswered == 0){
        this.incorect = 0;
      }else{
        this.incorect = output['exam']['question_num'] - output['correct_num'] - this.question_not_answered;
