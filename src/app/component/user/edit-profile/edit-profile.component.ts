...
export class EditProfileComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.editForm = this.fb.group({
      ...
      fullname: ['', [Validators.required,NoWhitespaceValidator, Validators.maxLength(100), Validators.minLength(2)]],
      phone: ['', [Validators.required,Validators.minLength(9),Validators.maxLength(11), Validators.pattern('^[0-9]*$')]],
