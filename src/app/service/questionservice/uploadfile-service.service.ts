...
export class UploadfileServiceService {
  ...
  getNumberQuestionOfChapter(subjectId) {
    const tk = localStorage.getItem('access_token');
    let head = new HttpHeaders();
    head = head.set('TOKEN', 'Token' + tk);
    return this.http.get<Object[]>(
      Constant.BASE_URL +
      '/question/getNumberQuestionOfChapter?subjectId=' +
      subjectId,
      {
        headers: head
      }
  ...
  getNumberQuestionOfDomain(subjectId) {
    const tk = localStorage.getItem('access_token');
    let head = new HttpHeaders();
    head = head.set('TOKEN', 'Token' + tk);
    return this.http.get<Object[]>(
      Constant.BASE_URL +
      '/question/getNumberQuestionOfDomain?subjectId=' +
      subjectId,
      {
        headers: head
      }
  ...
  countSeartQuestion(subjectId,keyword) {
    const tk = localStorage.getItem('access_token');
    let head = new HttpHeaders();
    head = head.set('TOKEN', 'Token' + tk);
    return this.http.get(
      Constant.BASE_URL +
      '/question/countSearchQuestion?subjectId=' +
      subjectId+'&keyword='+keyword,
      {
        headers: head
      }
    );
